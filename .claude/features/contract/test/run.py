...
run_test("test-build-contract-tdd-state-machine-sources.py")
run_test("test-build-contract-absorbed-skill-sources.py")
...
run_test("test-dispatch-feature-edit-py-only.py")
...
run_test("test-rabbit-feature-spec-deployment.py")
