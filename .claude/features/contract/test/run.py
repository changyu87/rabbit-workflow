...
run_test("test-spec-surface-prompts-list-matches-disk.py")
...
run_test("test-docs-layout-dual-read.py")
run_test("test-contract-spec-dir-migrated.py")
...
run_test("test-validate-feature-sweep.py")
run_test("test-validate-feature-ref-resolution.py")
run_test("test-contract-scripts-have-docstrings.py")
run_test("test-script-docstrings-no-historical-tags.py")
...
run_test("test-workspace-declares-skips-dot-dirs.py")
...
run_test("test-deprecation-criterion-governance-scoped.py")
run_test("test-native-workflow-decision-doc.py")
...
run_test("test-config-dispatch.py")
...
run_test("test-runtime-emit-configurable-alert-declarable.py")
run_test("test-runtime-vendored-marker-roots.py")
...
run_test("test-runtime-next-tick-eta.py")
run_test("test-runtime-emit-stop-timestamp.py")
run_test("test-runtime-display-timezone.py")
run_test("test-check-release-update-helper.py")
run_test("test-check-release-update-runtime-root.py")
run_test("test-update-banner-channel-not-pin.py")
run_test("test-spec-bodies-no-historical-tags.py")
run_test("test-spec-bodies-strict-tier.py")
run_test("test-spec-bodies-allowlist-rae-retired-literal.py")
run_test("test-spec-bodies-docs-layout.py")
run_test("test-spec-bodies-bb-vocab-retired.py")
run_test("test-spec-housekeeping-679-dead-prose-removed.py")
