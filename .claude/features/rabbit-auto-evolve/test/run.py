...
run_test("test-integration-target.py")
run_test("test-safety-check.py")
run_test("test-install-smoke.py")
run_test("test-spec-install-smoke-invariant.py")
run_test("test-merge-prs.py")
run_test("test-cleanup-branches.py")
run_test("test-release-bump.py")
run_test("test-release-track-source.py")
...
run_test("test-decomposition-native-sub-issue.py")
run_test("test-record-dispatch.py")
run_test("test-resume-dispatch.py")
run_test("test-spec-post-merge-invariant.py")
run_test("test-spec-integration-target-invariant.py")
run_test("test-check-auto-resume.py")
run_test("test-cron-trigger.py")
run_test("test-cron-cadence-source.py")
run_test("test-cron-cadence-config.py")
...
run_test("test-tick-jitter.py")
run_test("test-schedule-decision.py")
run_test("test-spec-refire-dedup-invariant.py")
run_test("test-refire-guard.py")
run_test("test-spec-refire-liveness-guard-invariant.py")
...
run_test("test-spec-comment-aware-triage-invariant.py")
run_test("test-capture-observed-error.py")
run_test("test-spec-self-observed-error-capture-invariant.py")
...
run_test("test-spec-housekeeping-751-deep-slim-consolidated.py")
run_test("test-spec-housekeeping-1166-skill-headless-sync-target.py")
run_test("test-spec-housekeeping-1167-resync-comment-target.py")
run_test("test-spec-housekeeping-1185-no-historical-tags.py")
