...
run_test("test-gitignore-seeded-runtime-artifacts.py")
...
run_test("test-record-decomposition.py")
run_test("test-close-decomposed-parents.py")
run_test("test-spec-post-merge-invariant.py")
run_test("test-check-auto-resume.py")
run_test("test-cron-trigger.py")
run_test("test-cron-cadence-source.py")
...
run_test("test-spec-refire-dedup-invariant.py")
...
run_test("test-spec-continuous-phase-numbering-invariant.py")
