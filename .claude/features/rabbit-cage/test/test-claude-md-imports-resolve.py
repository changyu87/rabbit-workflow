#!/usr/bin/env python3
"""test-claude-md-imports-resolve.py — assert every @-import in any CLAUDE.md resolves.

Traces: rabbit-cage spec Inv 14 — rabbit-cage owns the CLAUDE.md @-import
resolution tests because rabbit-cage owns the generate-claude-md content
producer that emits CLAUDE.md.
